...
answerchoice15 = AnswerChoice.create!(answer: "Bill Gates", question_id: question5.id)
answerchoice14 = AnswerChoice.create!(answer: "Steve Wozniak", question_id: question5.id)

Response.create!(answer_choice_id: answerchoice2.id, user_id: user1.id)
Response.create!(answer_choice_id: answerchoice9.id, user_id: user2.id)
Response.create!(answer_choice_id: answerchoice4.id, user_id: user3.id)
Response.create!(answer_choice_id: answerchoice6.id, user_id: user5.id)
Response.create!(answer_choice_id: answerchoice10.id, user_id: user6.id)
Response.create!(answer_choice_id: answerchoice8.id, user_id: user1.id)
